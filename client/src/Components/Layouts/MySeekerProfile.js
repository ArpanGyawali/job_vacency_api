...
const MySeekerProfile = ({
	...
	return isLoading && profile === null ? (
		...
		<Fragment>
			...
			{profile != null ? (
				<Fragment>
					<Link to='/updateSeekerProfile' className='btn btn-primary my-1'>
						Update Profile
					</Link>
				</Fragment>
			) : (
...
export default connect(mapStateToProps, { getMyProfile })(MySeekerProfile);
